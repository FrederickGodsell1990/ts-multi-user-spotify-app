...
const LOCALSTORAGE_KEYS = {
  ...
  // added post server set up to manage multiple users
...
const getAccessToken = () => {
  ...
  const queryParams = {
    ...
    // Client ID added to manage multiple login
    [LOCALSTORAGE_KEYS.Client_ID]: urlParams.get("Client_ID"),
  };
...
const hasTokenExpired = () => {
  ...
  // set this to 'return true' to test if refresh token function is working
